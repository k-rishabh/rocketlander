...
from envs.rocket import Rocket  # Import your Rocket environment class
...
def test():
    ...
    env = Rocket(max_steps=max_ep_len, task=task, rocket_type='falcon')  # Adjust for 'hover' task if needed
    ...
    run_num_pretrained = 4      # Set this to load a specific checkpoint number
